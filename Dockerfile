...
RUN apt-get update --yes && \
    apt-get install --yes --no-install-recommends graphviz curl qemu-utils podman slirp4netns fuse-overlayfs uidmap qemu-system-x86 docker-cli && \
    ...
    curl -LO https://github.com/abiosoft/colima/releases/download/v0.4.6/colima-Linux-x86_64  && \
